...
# 知识图谱增强的提示学习模块参数
parser.add_argument('--use_kg_enhanced_prompt', action='store_true', help='是否使用知识图谱增强的提示学习模块', default=True)
parser.add_argument('--kg_hidden_dim', type=int, default=256, help='图神经网络隐藏层维度')
parser.add_argument('--kg_num_layers', type=int, default=2, help='图神经网络层数')
parser.add_argument('--kg_window_size', type=int, default=5, help='构建时序关系的窗口大小')
parser.add_argument('--kg_fusion_type', type=str, default='concat', help='特征融合方式，可选：concat, attention, gate')
