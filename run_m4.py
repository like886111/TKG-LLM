...
from models.TKGLLM import TKGLLM
...
parser.add_argument('--sim_coef', type=float, default=-0.1)
parser.add_argument('--pool_size', type=int, default=1000)
parser.add_argument('--trend_length', type=int, default=24)
parser.add_argument('--seasonal_length', type=int, default=4)
parser.add_argument('--gpt_layers', type=int, default=6)
parser.add_argument('--prompt_init', type=str, default='text_prototype', help='prompt_init_type')
parser.add_argument('--use_kg_enhanced_prompt', action='store_true', help='whether to use knowledge graph enhanced prompt')
parser.add_argument('--kg_fusion_type', type=str, default='concat', help='knowledge graph fusion type: concat or attention')
parser.add_argument('--kg_hidden_dim', type=int, default=256, help='hidden dimension for knowledge graph')
...
for ii in range(args.itr):
    ...
    for epoch in range(args.train_epochs):
        ...
        for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
            ...
            loss += args.sim_coef*res['simlarity_loss']
        ...
        vali_loss = test(args, model, train_loader, vali_loader, criterion,ii)
        test_loss = vali_loss
        print(
    ...
    model.load_state_dict(torch.load(best_model_path, map_location=lambda storage, loc: storage))
